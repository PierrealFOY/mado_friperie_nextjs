...
function AboutSection() {
    return (
        <section id="about" className="flex justify-center md:my-12 md:pt-10">
            <Card className="flex-row w-full max-w-[48rem]">
                ...
                <CardBody>
                    <Typography variant="h6" color="blue" className="uppercase mb-4">C'est qui, c'est quoi ?</Typography>
